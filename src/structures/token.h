...
BEGIN_ENUM(token_type_t) {
    ...
    DECL_ENUM_ELEMENT(TOK_MUL), // "*"
    DECL_ENUM_ELEMENT(TOK_DIV), // "\"
    DECL_ENUM_ELEMENT(TOK_EX_MARK), // "!"
    DECL_ENUM_ELEMENT(TOK_EQ), // "="
    DECL_ENUM_ELEMENT(TOK_LEFT_ANGLE), // "<"
    DECL_ENUM_ELEMENT(TOK_RIGHT_ANGLE), // ">"
    DECL_ENUM_ELEMENT(TOK_NUMBER), // [0-9]+
    DECL_ENUM_ELEMENT(TOK_DOT), // "."
    DECL_ENUM_ELEMENT(TOK_COMMA), // ","
    DECL_ENUM_ELEMENT(TOK_AND), // "&"
    DECL_ENUM_ELEMENT(TOK_OR), // "|"
